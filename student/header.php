<?php
    ...
    $std_info = mysqli_query($link, "SELECT * FROM `students` WHERE `email` = '$login_std' OR `username` = '$login_std'");
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <div class="user-photo">
                            <img alt="profile photo" src="../images/students/<?= $row['image'] ?>" />
                        </div>
                        <div class="user-info">
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                <li> <a href="update_profile.php"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
